...
function pasarUsuarioAPremium(usuarios) {
  // "usuarios" es un array de objetos "usuario"  [{esPremium},{esPremium},{esPremium}]
...
function sumarLikesDeUsuario(usuario) {
  // "usuario" tiene una propiedad llamada "posts" que es un array {posts:[{likes: 12 },{likes: 12},{likes : 12}]}
